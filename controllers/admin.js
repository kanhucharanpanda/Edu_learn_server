...
// import { rm } from "fs"; // remove file or folder (fs.unlink for files and fs.rmdir for folder)
// import { promisify } from "util"; //convert callback api to promise based api
// import fs from "fs";
